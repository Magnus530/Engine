...
namespace Engine
{
	...
	public:
		...
		static Engine::Entity EntityInit(const Engine::ShaderType& shaderType, const std::string objname, std::shared_ptr<Engine::VertexArray>& vertexarr, 
			std::shared_ptr<Engine::Scene>& scene, const unsigned int& cubemapTex, const glm::vec3& color = { 1.f, 1.f, 1.f }, 
		...
		static void MaterialInit(const Engine::ShaderType& shaderType, Engine::Entity& entity, const unsigned int& cubemapTex, 
