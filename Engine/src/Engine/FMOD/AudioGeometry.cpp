...
namespace Engine {
	...
	//bool AudioGeometry::generatingBoundingBox(const Array<glm::vec3>& verts, glm::mat4 transformation)
	//{
	...
	//}
	//
	//bool AudioGeometry::generatingPlane(glm::vec3 _v1, glm::vec3 _v2, glm::vec3 _v3, glm::vec3 _v4, glm::mat4 transformation)
	//{
	...
	//}
	//
	//bool AudioGeometry::generateIndicesFromTirangles(const Array<glm::ivec3>& _faces)
	//{
